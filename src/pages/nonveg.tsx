...
const TablesPage = () => {
    ...
    if (selectedFile) {
      ...
      try {
        const response = await fetch(
          'http://3.13.92.74:30009/master-data/admin/non-veg/nonveg.csv',
          {
            method: 'POST',
            body: formData,
            headers: {
  ...
  const handleSearchClick = async () => {
    try {
      ...
      if (searchOption === 'id') {
        if (searchId) {
          url = `http://3.13.92.74:30009/master-data/admin/non-veg/id/${searchId}`
        ...
        url = `http://3.13.92.74:30009/master-data/admin/non-veg/name/${searchId}`
        const response = await fetch(url, {
          method: 'GET',
          headers: {
            'X-USER-ID': '1',
        ...
        url = `http://3.13.92.74:30009/master-data/admin/non-veg/regex/name/${searchId}`
        const response = await fetch(url, {
          method: 'GET',
          headers: {
            'X-USER-ID': '1',
